...
import { Command, CreditCard, Search, Settings, User } from "lucide-react";
...
export const ServerSearch: React.FC<ServerSearchProps> = ({ searchData }) => {
      ...
      >
        ...
        >
          <span className="text-xs">
            <Command className="w-3 h-3 text-zinc-500 dark:text-zinc-400" />
          </span>
          K
        </kbd>
      </button>
